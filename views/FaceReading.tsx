    ...
    <div className="space-y-10 animate-in fade-in duration-500 pb-20 px-0 md:px-6 pt-8 bg-[var(--bg-primary)] min-h-screen text-[var(--text-primary)]">
      ...
      <header className="px-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-3xl md:text-5xl font-heritage font-bold text-[var(--text-primary)] tracking-tight uppercase leading-none">Firasat Paras</h2>
            <p className="text-[var(--text-secondary)] uppercase text-[10px] tracking-[0.4em] font-black mt-1">Membaca Karakter Melalui Paras</p>
          </div>
        </div>
      </header>
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="space-y-2">
                <label className="text-[10px] font-black text-[var(--text-secondary)] uppercase tracking-widest flex items-center gap-2">
                  <User size={12} className="text-[var(--pasundan-green)]" /> Nama Lengkap Sesuai Sanad
                </label>
                <input 
                  type="text" 
                  value={name} 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-[var(--text-secondary)] uppercase tracking-widest flex items-center gap-2">
                    <Calendar size={12} className="text-[var(--pasundan-green)]" /> Tgl Lahir (HH-BB-TTTT)
                  </label>
                  <input 
                    type="text" 
                    value={birthDate} 
